    ...
    <InspectorControls>
      <PanelBody title={__('Section settings', 'kili-builder')}>
        <PanelRow>
          <ToggleControl
            ...
            onChange={(value) => { props.setAttributes({ useContainer: value }); }}
        ...
        <PanelRow className="kili-section__component-item">
          ...
          <MediaUploadCheck>
            <MediaUpload
              onSelect={(media) => { props.setAttributes({ mobileBackgroundImage: media.url, mobileBackgroundImageId: media.id }); }}
              allowedTypes={['image']}
        ...
        <PanelRow className="kili-section__component-item">
          ...
          <MediaUploadCheck>
            <MediaUpload
              onSelect={(media) => { props.setAttributes({ backgroundImage: media.url, backgroundImageId: media.id }); }}
              allowedTypes={['image']}
      ...
      <PanelBody title={__('Mobile settings', 'kili-builder')} initialOpen={false}>
        <PanelRow className="kili-section__component-item">
          <RangeControl
            ...
            onChange={(value) => { props.setAttributes({ marginBottomMobile: value }); }}
        ...
        <PanelRow className="kili-section__component-item">
          <RangeControl
            ...
            onChange={(value) => { props.setAttributes({ marginTopMobile: value }); }}
        ...
        <PanelRow className="kili-section__component-item">
          <RangeControl
            ...
            onChange={(value) => { props.setAttributes({ paddingBottomMobile: value }); }}
        ...
        <PanelRow className="kili-section__component-item">
          <RangeControl
            ...
            onChange={(value) => { props.setAttributes({ paddingTopMobile: value }); }}
      ...
      <PanelBody title={__('Desktop settings', 'kili-builder')} initialOpen={false}>
        <PanelRow className="kili-section__component-item">
          <RangeControl
            label={__('Margin bottom (in px)', 'kili-builder')}
            onChange={(value) => { props.setAttributes({ marginBottomDesktop: value }); }}
        ...
        <PanelRow className="kili-section__component-item">
          <RangeControl
            label={__('Margin top (in px)', 'kili-builder')}
            onChange={(value) => { props.setAttributes({ marginTopDesktop: value }); }}
        ...
        <PanelRow className="kili-section__component-item">
          <RangeControl
            label={__('Padding bottom (in px)', 'kili-builder')}
            onChange={(value) => { props.setAttributes({ paddingBottomDesktop: value }); }}
        ...
        <PanelRow className="kili-section__component-item">
          <RangeControl
            label={__('Padding top (in px)', 'kili-builder')}
            onChange={(value) => { props.setAttributes({ paddingTopDesktop: value }); }}
...
const saveBlock = function (props) {
  let styles = processStyles(props);
...
registerBlockType( 'kili/section', {
  ...
  title: __('Kili Section', 'kili-builder'),
