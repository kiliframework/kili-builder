	...
	constructor( {
      ...
      wp.media.view.Attachment.Details = wp.media.view.Attachment.Details.extend({
        ...
        render: function(){
            ...
            element.innerHTML = `<script type="text/html" id="tmpl-soliloquy-attachment-fields">
            ...
            this.$el.append(element.firstChild);
            console.log("model after apoend", this.model.toJSON());   
            console.log("el after append", this.$el);
